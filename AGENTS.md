...
## Inventário de análises (atualizado em agosto/2026)
...
**Backlog (versão avançada):** regressão linear múltipla
(finalizar), homogeneidade de variâncias (Levene/Bartlett), matriz de
