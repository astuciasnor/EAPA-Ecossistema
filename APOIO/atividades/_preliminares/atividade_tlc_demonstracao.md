# Atividade autonoma - Demonstracao do teorema do limite central

**Dados:** [demonstracao_tlc.xlsx](dados/demonstracao_tlc.xlsx)

**Origem interna:** aba `15_demo_tlc` de `dados_brutos_eapadados.xlsx`.
...
**Analise-alvo:** Distribuicao amostral e teorema do limite central.

## Contexto

Amostra numerica para explorar distribuicao e comportamento de medias amostrais.

## Problema de pesquisa

Investigue: **Como a distribuicao das medias amostrais se comporta a partir desta variavel?**
...
1. Importe o arquivo [demonstracao_tlc.xlsx](dados/demonstracao_tlc.xlsx) e identifique a unidade observacional, as variaveis e os possiveis valores ausentes ou inconsistentes.
2. Documente qualquer recodificacao, filtro ou reorganizacao necessaria.
3. Descreva a variavel, simule reamostragens com tamanhos definidos, compare distribuicoes de medias e discuta o TLC.
